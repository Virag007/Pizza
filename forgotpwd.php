...
<body>
	...
	<form method="post">
		<table>
			...
			<tr>
				<td><input type="password" name="new" required placeholder="New Password" id="password" pattern=".{5,12}" minlength="6" required title="Password should be 5 to 12 characters"></td>
			</tr>
			<tr>
