	...
	<div class="container">
		...
		<div class="about-content">
			<div class="col-md-6 bottom-left">
				...
				<p>Pizza is a traditional Italian dish consisting of a yeasted flatbread typically topped with tomato sauce and cheese and baked in an oven. It can also be topped with additional vegetables, meats, and condiments.</p>
				<p>Pizza is sold fresh or frozen, either whole or in portions.[6] Various types of ovens are used to cook them and many varieties exist. Several similar dishes are prepared from ingredients commonly used in pizza preparation, such as calzone and stromboli.</p>
				...
				<div class="col-md-4 agileits-w3layouts-grid">
					<div class="wthree_agile_us">
						<div class="col-xs-9 agile-why-text">
							<h4>Royal Feeling</h4>
							<p>You will get our Royal service.</p>
						</div>
					...
					<div class="wthree_agile_us">
						<div class="col-xs-9 agile-why-text">
							<h4>Perfect Delivery</h4>
							<p>We assure you the genuine and beleivable services.</p>
						</div>
						<div class="col-xs-3 agile-why-text">
							<div class="wthree_features_grid hvr-rectangle-out">
					...
					<div class="wthree_agile_us">
						<div class="col-xs-9 agile-why-text">
							<h4>Fall in Love with us</h4>
							<p>You will surely fall in love with our service.</p>
						</div>
						<div class="col-xs-3 agile-why-text">
							<div class="wthree_features_grid hvr-rectangle-out">
				...
				<div class="col-md-4 agileits-w3layouts-grid">
					...
					<div class="wthree_agile_us">
						...
						<div class="col-xs-9 agile-why-text two">
							...
							<p>Revive your live by Joining us.</p>
						</div>
					...
					<div class="wthree_agile_us">
						...
						<div class="col-xs-9 agile-why-text two">
							<h4>Enjoy</h4>
							<p>Mail us if u don't like our service</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="clearfix"> </div>
