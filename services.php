	...
	<div class="container">
		...
		<div class="col-md-8 col-sm-6 agileits w3layouts services-grid services-grid-1">
			<div class="col-md-4 col-sm-4 agileits w3layouts services-info services-info-1">
				...
				<p>Breakfast is the first meal of a day, most often eaten in the early morning before undertaking the day's work.</p>
			</div>
			...
			<div class="col-md-4 col-sm-4 services-info agileits w3layouts services-info-3">
				...
				<p>Whether you call them appetisers or entrees, starter recipes are incredibly important as they set the tone for the meal to come.</p>
			</div>
			<div class="col-md-4 agileits w3layouts col-sm-4 services-info services-info-4">
				...
				<p>Soup is a primarily liquid food, generally served warm or hot, that is made by combining ingredients.</p>
			</div>
			<div class="col-md-4 col-sm-4 services-info services-info-5 agileits w3layouts">
				<i class="fa fa-cutlery" aria-hidden="true"></i>
				<h4 class="agileits w3layouts">Dinner Food</h4>
				<p>Dinner usually refers to the most significant meal of the day, which can be at noon or in the evening.</p>
			</div>
...
<div class="background">
	<div class="container">
		<h3>order online</h3>
		<h5><span class="fa fa-phone" aria-hidden="true"></span> (+91) 3988 3988</h5>
			...
			<div class="footer-top">
				...
				<div class="col-md-4 ftr-grid fg2 mid-gd">
					...
					<div class="ftr-address">
						...
						<div class="ftr-text">
							<p>Aamtala Sukanta Pally, Near Saraitiar More, Golapbag</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="ftr-address">
				...
				<div class="col-md-4 ftr-grid fg2">
					<h3>Recent posts</h3>
					<p>SAVE THE PLANET, IT'S ONLY PLACE WHERE YOU GET THE DESPACITO PIZZA.</p>
