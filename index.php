...
<html lang="en">
<head>
<title>Welcome to Despacito Pizza</title>
<!-- custom-theme -->
	...
	<div class="container">
		<div class="bannerbottomgrids">
			<div class="col-md-6 bottomleft">
				...
				<p>Pizza is sold fresh or frozen, either whole or in portions.[6] Various types of ovens are used to cook them and many varieties exist. Several similar dishes are prepared from ingredients commonly used in pizza preparation, such as calzone and stromboli. In the United States, pizza is usually eaten out of hand after dividing into slices from a large pizza or small pizzetta as a whole.</p>
					<div class="agile-services-left-grid">
						<div class="services-icon">
							...
							<div class="col-md-10 services-icon-text">
								<h3>Royality</h3>
								<p>Enjoy the best experience with us. We make sure that you can nev forgot us. </p>
							</div>
						...
						<div class="services-icon">
							...
							<div class="col-md-10 services-icon-text">
								<h3>Come Here</h3>
								<p>We provide personalised and eco-freindly surrounding for dinner, lunch etc too. </p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="services-icon">
			...
			<div class="special-grids">
				<div class="col-md-6 w3l-special-grid">
					...
					<div class="col-md-6 agileits-special-info">
						<h4>Bread Egg</h4>
						<p>Sounds like breakfast...Yaa it's the only for you.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 w3l-special-grid">
					...
					<div class="col-md-6 agileits-special-info">
						<h4>Burger</h4>
						<p>Available in both vegeterian and non-vegeterian</p>
					</div>
				...
				<div class="col-md-6 w3l-special-grid">
					<div class="col-md-6 agileits-special-info">
						<h4>Pasta</h4>
						<p>Mum-ma-mia...Aakhri Pasta. Get your seat booked.</p>
					</div>
				...
				<div class="col-md-6 agileits-special-info">
						<h4>Know More</h4>
						<p>Log in with us. Become our member by just 2 steps. Just fill up our regestration form and get the latest one.</p>
					</div>
			...
			<div class="w3_agile_team_grids">
				<div class="col-md-3 w3_agile_team_grid">
					<div class="hover14 column">
						<figure><img src="images/chef.jpg" alt=" " class="img-responsive" /></figure>
					</div>
					<div class="team-tt">
						<h4>Virag</h4>
						<p>master chef</p>
					...
					<ul class="slides">
						<li>
							<div class="col-md-7 w3_testimonials_grid_left">
								<p><img src="images/q1.png" alt=" " class="" />Despacito is my favourite place when it tickles for pizzas.they serve amazing pizzas in town. .Quick service, courteous staff and yummy food is all what I want. Food was really good and staff was humble.A good number of variety , a good service , organised ,well maintained..They have all the goodiees . I love this place ♥ Loved paneer makhani 😍😍❤ it was cheesy … I ordered it without cheese burst still it was so damn good !!! Perfect crust and perfect blend of spices in pizza sauce !!! Despacito sach mein badal gya 🔥🔥🔥🔥🔥🔥 ..<img src="images/q2.png" alt=" " class="" /></p>
							</div>
						...
						<li>
							<div class="col-md-7 w3_testimonials_grid_left">
								<p><img src="images/q1.png" alt=" " class="" /> We all love despacito ,But when it comes to days when you are broke and still you want  to have something good.That is zingy parcel and a pizza mania ,I personally loves the zingy parcel alot with a coke.This Despacito is doing a great job In serving their customers.In case u never heard about Zingy PArcel do check out pics i captured for you guys. <img src="images/q2.png" alt=" " class="" /></p>
							</div>
							<div class="col-md-5 w3_testimonials_grid_right">
