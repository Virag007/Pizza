						...
						<ul class="nav navbar-nav">
							<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="profile.php?Userid=<?php echo $_SESSION['user']['Userid']?>"><?php echo $_SESSION['user']['Firstname'] ?></a></li>
...
$query="SELECT * FROM food";
	...
	{
		?>
		<br/><br/><br/><table align="center" border="2" width="100%" style="background-color:#f2f2f2">
			...
			while($each=mysqli_fetch_array($exec))
			{
				...
				<tr>
					...
					<td align="center"><img src="<?php echo $each['filepath']?>" height="150px" width="150px"/></td>
					...
					<td align="center"><a href="cart.php?foodId=<?php echo $each['foodId']?>"><img src="addtocart.jpg" height="50px" width="100px"/></a></td>
				</tr>
				<?php $sl++;
			}?>
		</tbody>
	...
	<?php
		...
		echo "<p style='color:red' align='center'><font size='4'><b><br><br><br>Nothing Here...Come Later</b></font></p>";
	?><br><br><br>
</div>
</div>
